...
const HamburgerSwitchMeat = styled.span`
  ...
  &:nth-child(1) {
    ...
    top: ${props => props.open?`calc(50% - ${Math.floor(props.meatHeight/2)}px - 1px)`:'0px'};
  ...
  &:nth-child(4) {
    transition: 0.3s ease-in-out;
    top: calc(${props => props.open?`50% - ${Math.floor(props.meatHeight/2)}px - 1px`:`100% - ${props.meatHeight}px - 1px`});
    width: ${props=>props.open?0:100}%;
    left: ${props=>props.open?50:0}%;
  }
`
