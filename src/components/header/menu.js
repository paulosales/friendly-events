const menuItems = [
  {
    anchor: "#home", icon: "fa-home",
    messageId: "menu.home", defaultMessage: "Home"
  },
  {
    anchor: "#events", icon: "fa-music",
  ...
  {
    anchor: "#features", icon: "fa-th-list",
    messageId: "menu.features", defaultMessage: "Features"
  },
  {
    anchor: "#offer", icon: "fa-tags",
    messageId: "menu.offer", defaultMessage: "Offer"
  },
  {
